      ...
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <div>
          ...
          <p className="text-default-500 mt-1">
            Track all your artwork purchases and earnings.
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-xl border border-default-200 bg-content1 p-4">
            ...
            <h2 className="text-2xl font-bold">{salesHistories.length}</h2>
          </div>
          ...
          <div className="rounded-xl border border-default-200 bg-content1 p-4">
            ...
            <h2 className="text-2xl font-bold">
              $
              {salesHistories.reduce((sum, item) => sum + (item.price || 0), 0)}
            </h2>
          </div>
          ...
          <div className="rounded-xl border border-default-200 bg-content1 p-4">
            ...
            <h2 className="text-2xl font-bold">
              {
                salesHistories.filter((item) => item.paymentStatus === "paid")
                  .length
              }
            </h2>
          </div>
